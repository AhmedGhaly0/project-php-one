...
<div class="login-box">
  ...
  <div class="card">
    <div class="card-body login-card-body">
      <p class="login-box-msg"> <?php echo (isset($error)) ?  "<p style='color:red;' class=\"login-box-msg\">". $error ."</p>" : "Login" ?> </p>
      ...
      <p class="mb-0">
        <a href="register.php" class="text-center ml-3 p-3 mb-3 ">Register a new membership</a>
      </p>
    </div>
    <!-- /.login-card-body -->
  </div>
